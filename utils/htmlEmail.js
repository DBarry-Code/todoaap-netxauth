...
export function html({ url, host, email }) {
    ...
    <h2 style="text-align: center; text-transform: uppercase;color: teal;">Welcome to Barry's Stuff.</h2>
    
    <h3 style="text-align: center; text-transform: uppercase;">${escapedHost}</h3>
    
    <p>Congratulations! You're almost set to start using Fancy ToDo APP.
